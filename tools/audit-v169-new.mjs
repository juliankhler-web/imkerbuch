...
async function main() {
 ...
 const script=await readFile(new URL('./audit-v169-new.js',import.meta.url),'utf8');
 ...
 await writeFile(new URL('neubereiche-results.json',reportDir),JSON.stringify(out,null,2));
